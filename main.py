...
cell_size = 15
number_of_cells = 25
grid_size = cell_size* number_of_cells
OFFSET = 75
...
#created a screen
screen = pygame.display.set_mode((2*OFFSET+grid_size,2*OFFSET+grid_size))
...
#basic setup is now completed
SNAKE_UPDATE= pygame.USEREVENT
pygame.time.set_timer(SNAKE_UPDATE, 200)

#now we are starting the game loop
while True:
    ...
    game.draw()
    title_surface = title_font.render("Py Snake",True,DARK_GREEN)
